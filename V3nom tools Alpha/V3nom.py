...
{red}┌───({white}{username_pc}@V3nom{red})─[{white}~/V3nom/Menu-1{red}]""".replace("(Osint)", f"{red}(Osint){white}").replace("(Lookup)", f"{red}(Lookup){white}").replace("(Stealer, Malware)", f"{red}(Stealer, Malware){white}").replace("(Paid)", f"{red}(Paid){white}")
...
{red}┌───({white}{username_pc}@V3nom{red})─[{white}~/V3nom/Menu-2{red}]""".replace("(Osint)", f"{red}(Osint){white}").replace("(Lookup)", f"{red}(Lookup){white}").replace("(Stealer, Malware)", f"{red}(Stealer, Malware){white}").replace("(Paid)", f"{red}(Paid){white}")
...
def Menu():
   ...
   banner = f"""{popup_version}{red}New Server: {white + discord_server + red}                                                                                        
                                        ...
                                        ___      ___  _______  _____  ___      ______   ___      ___ 
                                       |"  \    /"  |/" __   )(\"   \|"  \    /    " \ |"  \    /"  |
                                        \   \  //  /(__/ _) ./|.\\   \    |  // ____  \ \   \  //   |
                                         \\  \/. ./     /  // |: \.   \\  | /  /    ) :)/\\  \/.    |
                                          \.    //   __ \_ \\ |.  \    \. |(: (____/ //|: \.        |
                                           \\   /   (: \__) :\|    \    \ | \        / |.  \    /:  |
                                            \__/     \_______) \___|\____\)  \"_____/  |___|\__/|___|
