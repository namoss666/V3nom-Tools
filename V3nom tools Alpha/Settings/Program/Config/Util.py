...
avatar_webhook = "https://cdn.discordapp.com/attachments/1255888122474926081/1271811570069934100/image.png?ex=66b8b253&is=66b760d3&hm=c504922a3b82891a6391fae2e30e02e7f8d6665788ae16c4820e145b5eee906c&"
...
def Reset():
        if sys.platform.startswith("win"):
            file = f'python ./V3nom.py'
            subprocess.run(file, shell=True)
        elif sys.platform.startswith("linux"):
            file = f'python3 ./V3nom.py'
            subprocess.run(file, shell=True)
